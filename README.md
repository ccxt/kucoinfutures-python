...
- `public_get_margin_available_inventory(request)`
...
- `private_get_margin_borrowrate(request)`
...
- `private_get_affiliate_queryinvitees(request)`
- `private_get_affiliate_querymycommission(request)`
- `private_get_affiliate_querytransactionbyuid(request)`
- `private_get_affiliate_querytransactionbytime(request)`
- `private_get_affiliate_querykumining(request)`
...
- `broker_get_broker_nd_mark_up(request)`
...
- `broker_post_broker_nd_mark_up(request)`
...
- `uta_get_user_my_ip(request)`
- `uta_get_market_fiat_price(request)`
- `utav2_get_market_funding_rate(request)`
